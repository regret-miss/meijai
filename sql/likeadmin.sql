...
CREATE TABLE `la_dev_pay_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付配置表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `la_dev_pay_way`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '支付方式表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `la_gen_table_column`  (
  ...
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成字段表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for la_goods
-- ----------------------------
DROP TABLE IF EXISTS `la_goods`;
CREATE TABLE `la_goods`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `category_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '分类ID',
  `name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '商品名称',
  `image` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '商品主图',
  `images` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '商品轮播图(逗号分隔)',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '商品详情',
  `price_min` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '最低价格',
  `price_max` decimal(10, 2) UNSIGNED NOT NULL DEFAULT 0.00 COMMENT '最高价格',
  ...
  `sales_total` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '总销量',
  `sales_virtual` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '虚拟销量',
  `sort` int UNSIGNED NOT NULL DEFAULT 100 COMMENT '排序',
  `is_show` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否上架: [0=下架, 1=上架]',
  `is_delete` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除: [0=否, 1=是]',
  `create_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `delete_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
...
-- ----------------------------
-- Table structure for la_goods_category
-- ----------------------------
DROP TABLE IF EXISTS `la_goods_category`;
CREATE TABLE `la_goods_category`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `pid` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '父级ID',
  `name` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '分类名称',
  `image` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '分类图标',
  `sort` smallint UNSIGNED NOT NULL DEFAULT 50 COMMENT '排序',
  `is_show` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '是否显示: [0=否, 1=是]',
  `is_delete` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除: [0=否, 1=是]',
  `create_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
...
-- ----------------------------
-- Records of la_goods_category
-- ----------------------------

-- ----------------------------
-- Table structure for la_goods_sku
-- ----------------------------
DROP TABLE IF EXISTS `la_goods_sku`;
CREATE TABLE `la_goods_sku`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `goods_id` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '商品ID',
  `sku_name` varchar(120) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'SKU名称(规格组合)',
  `image` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT 'SKU图片',
  ...
  `sku_data` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT 'SKU规格数据(JSON)',
  `is_delete` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否删除: [0=否, 1=是]',
  `create_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `delete_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品SKU表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of la_goods_sku
-- ----------------------------
...
CREATE TABLE `la_log_money`  (
  ...
  `delete_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账户变动日志表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of la_log_money
-- ----------------------------
...
CREATE TABLE `la_notice_record`  (
  ...
  `delete_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '消息通知记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `la_recharge_order`  (
  ...
  `delete_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '充值余额订单表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `la_refund_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '退款日志表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `la_system_auth_admin` VALUES (1, '0', '1', '', 'admin', 'admin', '4919832b10f1d2133c0f24a7dbe8330e', '/api/static/backend_avatar.png', 'Huku0', 0, 1, 0, 0, '127.0.0.1', 1786444520, 1642321599, 1670376604, 0);
...
CREATE TABLE `la_system_auth_menu`  (
  ...
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 803 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统菜单管理表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `la_system_auth_menu` VALUES (700, 0, 'M', '素材管理', 'el-icon-Picture', 43, '', 'material', '', '', '', 0, 0, 1, 1660203293, 1786438964);
INSERT INTO `la_system_auth_menu` VALUES (701, 700, 'C', '素材中心', 'el-icon-PictureRounded', 0, '', 'index', 'material/index', '', '', 0, 0, 1, 1660203402, 1786439055);
INSERT INTO `la_system_auth_menu` VALUES (703, 0, 'M', '文章资讯', 'el-icon-ChatLineSquare', 49, '', 'article', '', '', '', 0, 0, 1, 1661757636, 1786438855);
INSERT INTO `la_system_auth_menu` VALUES (704, 703, 'C', '文章管理', 'el-icon-ChatDotSquare', 3, 'article:list', 'lists', 'article/lists/index', '', '', 1, 0, 1, 1661757743, 1786439011);
INSERT INTO `la_system_auth_menu` VALUES (705, 703, 'C', '文章栏目', 'el-icon-CollectionTag', 0, 'article:cate:list', 'column', 'article/column/index', '', '', 1, 0, 1, 1661759218, 1786439036);
INSERT INTO `la_system_auth_menu` VALUES (706, 0, 'M', '渠道设置', 'el-icon-Message', 46, '', 'channel', '', '', '', 0, 0, 1, 1661767630, 1786439468);
INSERT INTO `la_system_auth_menu` VALUES (707, 706, 'C', 'H5设置', 'el-icon-Cellphone', 0, 'channel:h5:detail', 'h5', 'channel/h5', '', '', 0, 0, 1, 1661768566, 1786439269);
INSERT INTO `la_system_auth_menu` VALUES (708, 706, 'M', '微信公众号', 'local-icon-dingdan', 0, '', 'wx_oa', '', '', '', 0, 0, 1, 1661769386, 1786439281);
INSERT INTO `la_system_auth_menu` VALUES (709, 708, 'C', '公众号配置', '', 0, 'channel:oa:detail', 'config', 'channel/wx_oa/config', '', '', 0, 0, 1, 1661769457, 1786439334);
INSERT INTO `la_system_auth_menu` VALUES (710, 706, 'C', '微信小程序', 'local-icon-qudao_xiaochengxu', 0, 'channel:mp:detail', 'weapp', 'channel/weapp', '', '', 0, 0, 1, 1661823746, 1786439276);
INSERT INTO `la_system_auth_menu` VALUES (711, 706, 'C', '微信开放平台', 'local-icon-weixin', 0, 'channel:op:detail', 'wx_op', 'channel/wx_op', '', '', 0, 0, 1, 1661824989, 1786439263);
...
INSERT INTO `la_system_auth_menu` VALUES (717, 0, 'M', '装修管理', 'el-icon-Brush', 47, '', 'decoration', '', '', '', 0, 0, 1, 1661845634, 1786438904);
INSERT INTO `la_system_auth_menu` VALUES (718, 717, 'C', '页面装修', 'el-icon-CopyDocument', 0, 'decorate:pages:detail', 'pages', 'decoration/pages/index', '', '', 0, 0, 1, 1661845678, 1786439126);
INSERT INTO `la_system_auth_menu` VALUES (719, 717, 'C', '底部导航', 'el-icon-Position', 0, 'decorate:tabbar:detail', 'tabbar', 'decoration/tabbar', '', '', 0, 0, 1, 1661845811, 1786439132);
INSERT INTO `la_system_auth_menu` VALUES (720, 794, 'M', '消息通知', 'el-icon-Message', 9, '', 'message', '', '', '', 0, 0, 1, 1661848742, 1786439075);
INSERT INTO `la_system_auth_menu` VALUES (721, 720, 'C', '通知设置', '', 0, 'setting:notice:list', 'notice', 'message/notice/index', '', '', 0, 0, 1, 1661848772, 1786439216);
INSERT INTO `la_system_auth_menu` VALUES (722, 720, 'C', '通知详情', '', 0, 'setting:notice:detail', 'notice/edit', 'message/notice/edit', '/setting/message/notice', '', 0, 0, 1, 1661848944, 1786439220);
INSERT INTO `la_system_auth_menu` VALUES (723, 720, 'C', '短信设置', '', 0, 'setting:sms:list', 'short_letter', 'message/short_letter/index', '', '', 0, 0, 1, 1661848995, 1786439226);
...
INSERT INTO `la_system_auth_menu` VALUES (728, 500, 'C', '热门搜索', 'el-icon-Search', 7, 'setting:search:detail', 'search', 'setting/search/index', '', '', 0, 0, 1, 1662540429, 1786439392);
...
INSERT INTO `la_system_auth_menu` VALUES (748, 708, 'C', '菜单管理', '', 0, 'channel:oaMenu:detail', 'menu', 'channel/wx_oa/menu', '', '', 0, 0, 1, 1663050714, 1786439340);
INSERT INTO `la_system_auth_menu` VALUES (750, 708, 'C', '关注回复', '', 0, 'channel:oaReplyFollow:list', 'follow', 'channel/wx_oa/reply/follow_reply', '', '', 0, 0, 1, 1663149592, 1786439345);
INSERT INTO `la_system_auth_menu` VALUES (751, 708, 'C', '关键字回复', '', 0, 'channel:oaReplyKeyword:list', 'keyword', 'channel/wx_oa/reply/keyword_reply', '', '', 0, 0, 1, 1663149622, 1786439351);
INSERT INTO `la_system_auth_menu` VALUES (752, 708, 'C', '默认回复', '', 0, 'channel:oaReplyDefault:list', 'default', 'channel/wx_oa/reply/default_reply', '', '', 0, 0, 1, 1663149650, 1786439357);
...
INSERT INTO `la_system_auth_menu` VALUES (775, 703, 'C', '文章添加/编辑', '', 0, 'article:add/edit', 'lists/edit', 'article/lists/edit', '/article/lists', '', 0, 0, 1, 1668677477, 1786439042);
...
INSERT INTO `la_system_auth_menu` VALUES (779, 717, 'C', 'PC端', 'el-icon-Monitor', 0, '', 'pc', 'decoration/pc', '', '', 0, 0, 1, 1673248971, 1786439137);
INSERT INTO `la_system_auth_menu` VALUES (780, 0, 'M', '模板', 'el-icon-SetUp', 0, '', 'template', '', '', '', 0, 0, 1, 1673319812, 1786438813);
INSERT INTO `la_system_auth_menu` VALUES (781, 780, 'M', '组件示例', 'el-icon-Coin', 0, '', 'component', '', '', '', 0, 0, 1, 1673319842, 1786439066);
INSERT INTO `la_system_auth_menu` VALUES (782, 781, 'C', '富文本', '', 0, '', 'rich_text', 'template/component/rich_text', '', '', 0, 0, 1, 1673319879, 1786439185);
INSERT INTO `la_system_auth_menu` VALUES (783, 781, 'C', '上传文件', '', 0, '', 'upload', 'template/component/upload', '', '', 0, 0, 1, 1673319905, 1786439191);
INSERT INTO `la_system_auth_menu` VALUES (784, 781, 'C', '图标', '', 0, '', 'icon', 'template/component/icon', '', '', 0, 0, 1, 1673319936, 1786439196);
INSERT INTO `la_system_auth_menu` VALUES (785, 781, 'C', '文件选择器', '', 0, '', 'file', 'template/component/file', '', '', 0, 0, 1, 1673319972, 1786439178);
INSERT INTO `la_system_auth_menu` VALUES (786, 781, 'C', '链接选择器', '', 0, '', 'link', 'template/component/link', '', '', 0, 0, 1, 1673319997, 1786439167);
INSERT INTO `la_system_auth_menu` VALUES (787, 781, 'C', '超出自动打点', '', 0, '', 'overflow', 'template/component/overflow', '', '', 0, 0, 1, 1673320021, 1786439161);
INSERT INTO `la_system_auth_menu` VALUES (788, 781, 'C', '悬浮input', '', 0, '', 'popover_input', 'template/component/popover_input', '', '', 0, 0, 1, 1673320046, 1786439172);
INSERT INTO `la_system_auth_menu` VALUES (789, 500, 'M', '支付设置', 'local-icon-fukuan', 0, '', 'pay', '', '', '', 0, 0, 1, 1680082358, 1786439385);
INSERT INTO `la_system_auth_menu` VALUES (790, 789, 'C', '支付方式', '', 0, 'setting:payment:method', 'method', 'setting/pay/method/index', '', '', 0, 0, 1, 1680082434, 1786439444);
INSERT INTO `la_system_auth_menu` VALUES (791, 790, 'A', '保存', '', 0, 'setting:payment:editMethod', '', '', '', '', 0, 1, 0, 1680082473, 1680082473);
INSERT INTO `la_system_auth_menu` VALUES (792, 789, 'C', '支付配置', '', 0, 'setting:payment:list', 'config', 'setting/pay/config/index', '', '', 0, 0, 1, 1680083681, 1786439449);
INSERT INTO `la_system_auth_menu` VALUES (793, 792, 'A', '配置', '', 0, 'setting:payment:editConfig', '', '', '', '', 0, 1, 0, 1680083734, 1680083734);
INSERT INTO `la_system_auth_menu` VALUES (794, 0, 'M', '应用管理', 'el-icon-Postcard', 0, '', 'app', '', '', '', 0, 0, 1, 1680157467, 1786438933);
INSERT INTO `la_system_auth_menu` VALUES (795, 794, 'C', '用户充值', 'local-icon-caiwu', 0, 'marketing:recharge:detail', 'recharge', 'app/recharge/index', '', '', 0, 0, 1, 1680158031, 1786439080);
INSERT INTO `la_system_auth_menu` VALUES (796, 795, 'A', '保存', '', 0, 'marketing:recharge:save', '', '', '', '', 0, 1, 0, 1680158056, 1680158056);
INSERT INTO `la_system_auth_menu` VALUES (797, 0, 'M', '财务管理', 'local-icon-user_gaikuang', 0, '', 'finance', '', '', '', 0, 0, 1, 1680169445, 1786438939);
INSERT INTO `la_system_auth_menu` VALUES (798, 797, 'C', '充值记录', 'el-icon-Wallet', 0, 'finance:recharger:list', 'recharge_record', 'finance/recharge_record', '', '', 0, 0, 1, 1680169574, 1786439092);
INSERT INTO `la_system_auth_menu` VALUES (799, 797, 'C', '余额明细', 'local-icon-qianbao', 0, 'finance:wallet:list', 'balance_details', 'finance/balance_details', '', '', 0, 0, 1, 1680169658, 1786439097);
INSERT INTO `la_system_auth_menu` VALUES (800, 797, 'C', '退款记录', 'local-icon-heshoujilu', 0, 'finance:refund:list', 'refund_record', 'refund_record', '', '', 0, 0, 1, 1680171454, 1786439102);
...
INSERT INTO `la_system_auth_menu` VALUES (900, 0, 'M', '商品管理', 'el-icon-Goods', 42, '', 'goods', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (901, 900, 'C', '商品分类', 'el-icon-Menu', 0, 'goods:category:list', 'category', 'goods/category/index', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (902, 901, 'A', '分类详情', '', 0, 'goods:category:detail', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (903, 901, 'A', '分类新增', '', 0, 'goods:category:add', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (904, 901, 'A', '分类编辑', '', 0, 'goods:category:edit', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (905, 901, 'A', '分类删除', '', 0, 'goods:category:del', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (906, 901, 'A', '分类状态', '', 0, 'goods:category:change', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (910, 900, 'C', '商品列表', 'el-icon-ShoppingBag', 0, 'goods:list', 'lists', 'goods/lists/index', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (911, 910, 'A', '商品详情', '', 0, 'goods:detail', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (912, 910, 'A', '商品新增', '', 0, 'goods:add', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (913, 910, 'A', '商品编辑', '', 0, 'goods:edit', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (914, 910, 'A', '商品删除', '', 0, 'goods:del', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (915, 910, 'A', '商品上架/下架', '', 0, 'goods:change', '', '', '', '', 0, 1, 0, 1690000000, 1690000000);
INSERT INTO `la_system_auth_menu` VALUES (916, 1000, 'C', '商品添加/编辑', '', 0, 'goods:add/edit', 'lists/edit', 'goods/lists/edit', '/goods/lists', '', 0, 0, 0, 1690000000, 1690000000);
...
CREATE TABLE `la_system_config`  (
  ...
  `update_time` int UNSIGNED NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 201 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统全局配置表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `la_system_log_login` VALUES (1, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1786437722);
INSERT INTO `la_system_log_login` VALUES (2, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1786437755);
INSERT INTO `la_system_log_login` VALUES (3, 1, 'admin', '127.0.0.1', 'Windows', 'Chrome', 1, 1786444520);
...
-- ----------------------------
INSERT INTO `la_system_log_operate` VALUES (1, 1, 'GET', '角色列表', '127.0.0.1', '/api/system/role/list', 'com.mdd.admin.controller.system.SystemAuthRoleController.list()', 'pageNo=1&pageSize=15', '', 1, 1786438347, 1786438347, 46, 1786438347);
INSERT INTO `la_system_log_operate` VALUES (2, 1, 'POST', '上传图片', '127.0.0.1', '/api/upload/image', 'com.mdd.admin.controller.UploadController.image()', 'A (103).png', NULL, 2, 1786438759, 1786438759, 15, 1786438759);
INSERT INTO `la_system_log_operate` VALUES (3, 1, 'POST', '上传图片', '127.0.0.1', '/api/upload/image', 'com.mdd.admin.controller.UploadController.image()', 'A (187).jpeg', NULL, 2, 1786438775, 1786438775, 5, 1786438775);
INSERT INTO `la_system_log_operate` VALUES (4, 1, 'GET', '角色列表', '127.0.0.1', '/api/system/role/list', 'com.mdd.admin.controller.system.SystemAuthRoleController.list()', 'pageNo=1&pageSize=15', '', 1, 1786438792, 1786438792, 10, 1786438792);
INSERT INTO `la_system_log_operate` VALUES (5, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":780,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-SetUp\",\"menuName\":\"模板\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"template\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438813, 1786438813, 11, 1786438813);
INSERT INTO `la_system_log_operate` VALUES (6, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":703,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-ChatLineSquare\",\"menuName\":\"文章资讯\",\"menuSort\":49,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"article\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438855, 1786438855, 6, 1786438855);
INSERT INTO `la_system_log_operate` VALUES (7, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":717,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Brush\",\"menuName\":\"装修管理\",\"menuSort\":47,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"decoration\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438904, 1786438904, 7, 1786438904);
INSERT INTO `la_system_log_operate` VALUES (8, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":794,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Postcard\",\"menuName\":\"应用管理\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"app\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438933, 1786438933, 7, 1786438933);
INSERT INTO `la_system_log_operate` VALUES (9, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":797,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-user_gaikuang\",\"menuName\":\"财务管理\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"finance\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438939, 1786438939, 7, 1786438939);
INSERT INTO `la_system_log_operate` VALUES (10, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":700,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Picture\",\"menuName\":\"素材管理\",\"menuSort\":43,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"material\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786438964, 1786438964, 7, 1786438964);
INSERT INTO `la_system_log_operate` VALUES (11, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"article/lists/index\",\"id\":704,\"isCache\":1,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-ChatDotSquare\",\"menuName\":\"文章管理\",\"menuSort\":3,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"lists\",\"perms\":\"article:list\",\"pid\":703,\"selected\":\"\"}]', '', 1, 1786439011, 1786439011, 7, 1786439011);
INSERT INTO `la_system_log_operate` VALUES (12, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"article/column/index\",\"id\":705,\"isCache\":1,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-CollectionTag\",\"menuName\":\"文章栏目\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"column\",\"perms\":\"article:cate:list\",\"pid\":703,\"selected\":\"\"}]', '', 1, 1786439036, 1786439036, 9, 1786439036);
INSERT INTO `la_system_log_operate` VALUES (13, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"article/lists/edit\",\"id\":775,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"文章添加/编辑\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"lists/edit\",\"perms\":\"article:add/edit\",\"pid\":703,\"selected\":\"/article/lists\"}]', '', 1, 1786439042, 1786439042, 4, 1786439042);
INSERT INTO `la_system_log_operate` VALUES (14, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"material/index\",\"id\":701,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-PictureRounded\",\"menuName\":\"素材中心\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"index\",\"perms\":\"\",\"pid\":700,\"selected\":\"\"}]', '', 1, 1786439055, 1786439055, 7, 1786439055);
INSERT INTO `la_system_log_operate` VALUES (15, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":781,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Coin\",\"menuName\":\"组件示例\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"component\",\"perms\":\"\",\"pid\":780,\"selected\":\"\"}]', '', 1, 1786439066, 1786439066, 6, 1786439066);
INSERT INTO `la_system_log_operate` VALUES (16, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":720,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Message\",\"menuName\":\"消息通知\",\"menuSort\":9,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"message\",\"perms\":\"\",\"pid\":794,\"selected\":\"\"}]', '', 1, 1786439075, 1786439075, 6, 1786439075);
INSERT INTO `la_system_log_operate` VALUES (17, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"app/recharge/index\",\"id\":795,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-caiwu\",\"menuName\":\"用户充值\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"recharge\",\"perms\":\"marketing:recharge:detail\",\"pid\":794,\"selected\":\"\"}]', '', 1, 1786439080, 1786439080, 5, 1786439080);
INSERT INTO `la_system_log_operate` VALUES (18, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"finance/recharge_record\",\"id\":798,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Wallet\",\"menuName\":\"充值记录\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"recharge_record\",\"perms\":\"finance:recharger:list\",\"pid\":797,\"selected\":\"\"}]', '', 1, 1786439092, 1786439092, 8, 1786439092);
INSERT INTO `la_system_log_operate` VALUES (19, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"finance/balance_details\",\"id\":799,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-qianbao\",\"menuName\":\"余额明细\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"balance_details\",\"perms\":\"finance:wallet:list\",\"pid\":797,\"selected\":\"\"}]', '', 1, 1786439097, 1786439097, 8, 1786439097);
INSERT INTO `la_system_log_operate` VALUES (20, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"refund_record\",\"id\":800,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-heshoujilu\",\"menuName\":\"退款记录\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"refund_record\",\"perms\":\"finance:refund:list\",\"pid\":797,\"selected\":\"\"}]', '', 1, 1786439102, 1786439102, 7, 1786439102);
INSERT INTO `la_system_log_operate` VALUES (21, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"decoration/pages/index\",\"id\":718,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-CopyDocument\",\"menuName\":\"页面装修\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"pages\",\"perms\":\"decorate:pages:detail\",\"pid\":717,\"selected\":\"\"}]', '', 1, 1786439126, 1786439126, 4, 1786439126);
INSERT INTO `la_system_log_operate` VALUES (22, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"decoration/tabbar\",\"id\":719,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Position\",\"menuName\":\"底部导航\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"tabbar\",\"perms\":\"decorate:tabbar:detail\",\"pid\":717,\"selected\":\"\"}]', '', 1, 1786439132, 1786439132, 7, 1786439132);
INSERT INTO `la_system_log_operate` VALUES (23, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"decoration/pc\",\"id\":779,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Monitor\",\"menuName\":\"PC端\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"pc\",\"perms\":\"\",\"pid\":717,\"selected\":\"\"}]', '', 1, 1786439137, 1786439137, 5, 1786439137);
INSERT INTO `la_system_log_operate` VALUES (24, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/overflow\",\"id\":787,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"超出自动打点\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"overflow\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439161, 1786439161, 8, 1786439161);
INSERT INTO `la_system_log_operate` VALUES (25, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/link\",\"id\":786,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"链接选择器\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"link\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439167, 1786439167, 6, 1786439167);
INSERT INTO `la_system_log_operate` VALUES (26, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/popover_input\",\"id\":788,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"悬浮input\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"popover_input\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439172, 1786439172, 5, 1786439172);
INSERT INTO `la_system_log_operate` VALUES (27, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/file\",\"id\":785,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"文件选择器\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"file\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439178, 1786439178, 8, 1786439178);
INSERT INTO `la_system_log_operate` VALUES (28, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/rich_text\",\"id\":782,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"富文本\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"rich_text\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439185, 1786439185, 8, 1786439185);
INSERT INTO `la_system_log_operate` VALUES (29, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/upload\",\"id\":783,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"上传文件\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"upload\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439191, 1786439191, 4, 1786439191);
INSERT INTO `la_system_log_operate` VALUES (30, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"template/component/icon\",\"id\":784,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"图标\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"icon\",\"perms\":\"\",\"pid\":781,\"selected\":\"\"}]', '', 1, 1786439196, 1786439196, 6, 1786439196);
INSERT INTO `la_system_log_operate` VALUES (31, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"message/notice/index\",\"id\":721,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"通知设置\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"notice\",\"perms\":\"setting:notice:list\",\"pid\":720,\"selected\":\"\"}]', '', 1, 1786439216, 1786439216, 7, 1786439216);
INSERT INTO `la_system_log_operate` VALUES (32, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"message/notice/edit\",\"id\":722,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"通知详情\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"notice/edit\",\"perms\":\"setting:notice:detail\",\"pid\":720,\"selected\":\"/setting/message/notice\"}]', '', 1, 1786439220, 1786439220, 5, 1786439220);
INSERT INTO `la_system_log_operate` VALUES (33, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"message/short_letter/index\",\"id\":723,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"短信设置\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"short_letter\",\"perms\":\"setting:sms:list\",\"pid\":720,\"selected\":\"\"}]', '', 1, 1786439226, 1786439226, 7, 1786439226);
INSERT INTO `la_system_log_operate` VALUES (34, 1, 'GET', '角色列表', '127.0.0.1', '/api/system/role/list', 'com.mdd.admin.controller.system.SystemAuthRoleController.list()', 'pageNo=1&pageSize=15', '', 1, 1786439238, 1786439238, 6, 1786439238);
INSERT INTO `la_system_log_operate` VALUES (35, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_op\",\"id\":711,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-weixin\",\"menuName\":\"微信开放平台\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"wx_op\",\"perms\":\"channel:op:detail\",\"pid\":706,\"selected\":\"\"}]', '', 1, 1786439263, 1786439263, 6, 1786439263);
INSERT INTO `la_system_log_operate` VALUES (36, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/h5\",\"id\":707,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Cellphone\",\"menuName\":\"H5设置\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"h5\",\"perms\":\"channel:h5:detail\",\"pid\":706,\"selected\":\"\"}]', '', 1, 1786439269, 1786439269, 7, 1786439269);
INSERT INTO `la_system_log_operate` VALUES (37, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/weapp\",\"id\":710,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-qudao_xiaochengxu\",\"menuName\":\"微信小程序\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"weapp\",\"perms\":\"channel:mp:detail\",\"pid\":706,\"selected\":\"\"}]', '', 1, 1786439276, 1786439276, 7, 1786439276);
INSERT INTO `la_system_log_operate` VALUES (38, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":708,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-dingdan\",\"menuName\":\"微信公众号\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"wx_oa\",\"perms\":\"\",\"pid\":706,\"selected\":\"\"}]', '', 1, 1786439281, 1786439281, 6, 1786439281);
INSERT INTO `la_system_log_operate` VALUES (39, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_oa/config\",\"id\":709,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"公众号配置\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"config\",\"perms\":\"channel:oa:detail\",\"pid\":708,\"selected\":\"\"}]', '', 1, 1786439334, 1786439334, 4, 1786439334);
INSERT INTO `la_system_log_operate` VALUES (40, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_oa/menu\",\"id\":748,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"菜单管理\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"menu\",\"perms\":\"channel:oaMenu:detail\",\"pid\":708,\"selected\":\"\"}]', '', 1, 1786439340, 1786439340, 4, 1786439340);
INSERT INTO `la_system_log_operate` VALUES (41, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_oa/reply/follow_reply\",\"id\":750,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"关注回复\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"follow\",\"perms\":\"channel:oaReplyFollow:list\",\"pid\":708,\"selected\":\"\"}]', '', 1, 1786439345, 1786439345, 6, 1786439345);
INSERT INTO `la_system_log_operate` VALUES (42, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_oa/reply/keyword_reply\",\"id\":751,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"关键字回复\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"keyword\",\"perms\":\"channel:oaReplyKeyword:list\",\"pid\":708,\"selected\":\"\"}]', '', 1, 1786439351, 1786439351, 5, 1786439351);
INSERT INTO `la_system_log_operate` VALUES (43, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"channel/wx_oa/reply/default_reply\",\"id\":752,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"默认回复\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"default\",\"perms\":\"channel:oaReplyDefault:list\",\"pid\":708,\"selected\":\"\"}]', '', 1, 1786439357, 1786439357, 7, 1786439357);
INSERT INTO `la_system_log_operate` VALUES (44, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":789,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"local-icon-fukuan\",\"menuName\":\"支付设置\",\"menuSort\":0,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"pay\",\"perms\":\"\",\"pid\":500,\"selected\":\"\"}]', '', 1, 1786439385, 1786439385, 6, 1786439385);
INSERT INTO `la_system_log_operate` VALUES (45, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"setting/search/index\",\"id\":728,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Search\",\"menuName\":\"热门搜索\",\"menuSort\":7,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"search\",\"perms\":\"setting:search:detail\",\"pid\":500,\"selected\":\"\"}]', '', 1, 1786439392, 1786439392, 7, 1786439392);
INSERT INTO `la_system_log_operate` VALUES (46, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"setting/pay/method/index\",\"id\":790,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"支付方式\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"method\",\"perms\":\"setting:payment:method\",\"pid\":789,\"selected\":\"\"}]', '', 1, 1786439444, 1786439444, 5, 1786439444);
INSERT INTO `la_system_log_operate` VALUES (47, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"setting/pay/config/index\",\"id\":792,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"\",\"menuName\":\"支付配置\",\"menuSort\":0,\"menuType\":\"C\",\"params\":\"\",\"paths\":\"config\",\"perms\":\"setting:payment:list\",\"pid\":789,\"selected\":\"\"}]', '', 1, 1786439449, 1786439449, 9, 1786439449);
INSERT INTO `la_system_log_operate` VALUES (48, 1, 'POST', '菜单编辑', '127.0.0.1', '/api/system/menu/edit', 'com.mdd.admin.controller.system.SystemAuthMenuController.edit()', '[{\"component\":\"\",\"id\":706,\"isCache\":0,\"isDisable\":1,\"isShow\":0,\"menuIcon\":\"el-icon-Message\",\"menuName\":\"渠道设置\",\"menuSort\":46,\"menuType\":\"M\",\"params\":\"\",\"paths\":\"channel\",\"perms\":\"\",\"pid\":0,\"selected\":\"\"}]', '', 1, 1786439468, 1786439468, 6, 1786439468);
INSERT INTO `la_system_log_operate` VALUES (49, 1, 'GET', '角色列表', '127.0.0.1', '/api/system/role/list', 'com.mdd.admin.controller.system.SystemAuthRoleController.list()', 'pageNo=1&pageSize=15', '', 1, 1786439511, 1786439511, 6, 1786439511);
...
CREATE TABLE `la_user_auth`  (
  ...
  `terminal` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '客户端类型: [1=微信小程序, 2=微信公众号, 3=手机H5, 4=电脑PC, 5=苹果APP, 6=安卓APP]',
  `create_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
